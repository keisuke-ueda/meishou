...
<?php get_header(); ?>
  ...
  <main class="container mt-5 animate__animated animate__zoomIn animate__delay-1s">
    ...
    <div class="row mt-5 align-items-center">
      <div class="col-md-6">
        <h5 class="text-light">これまで警備、内装、中古家具などの販売などの経験を経て、明彰は2021年3月に事業を立ち上げ、オフィス周りを中心に移転業の窓口やコンサルを行っています<br><br>
          本来ならば、お客様が各業者に問い合わせるなど手間がかかってしまう部分も、弊社が代行を行なって「ワンストップ」で手続きができるようにして、
          お客様の負担を最大限減らして、スムーズな作業をさせていただきます<br><br>
          よりお客様の負担がないように、かつお客様のご要望に寄り添えるご提案をさせていただきます</h5>
      </div>
